...
public class CreateJobApiReqStepDef {
    ...
    public void the_header_of_the_create_job_request(DataTable dataTable) {
        ...
        reqSpec = given(); //Rest assured static import
    ...
    public void the_body_of_the_post_request() {
        ...
        reqSpec.body("{\"mst_service_location_id\":0,\"mst_platform_id\":2,\"mst_warrenty_status_id\":1,\"mst_oem_id\":1,\"customer\":{\"first_name\":\"" + details.get("fName") + "\",\"last_name\":\"" + details.get("lName") + "\",\"mobile_number\":\"" + details.get("number") + "\",\"mobile_number_alt\":\"\",\"email_id\":\"" + details.get("email") + "\",\"email_id_alt\":\"\"},\"customer_address\":{\"flat_number\":\"" + details.get("flatNumber") + "\",\"apartment_name\":\"" + details.get("apptName") + "\",\"street_name\":\"" + details.get("streetName") + "\",\"landmark\":\"" + details.get("landmark") + "\",\"area\":\"" + details.get("area") + "\",\"pincode\":\"" + details.get("pincode") + "\",\"country\":\"India\",\"state\":\"" + details.get("state") + "\"},\"customer_product\":{\"dop\":\"2025-06-19T18:30:00.000Z\",\"serial_number\":\"" + details.get("imei") + "\",\"imei1\":\"" + details.get("imei") + "\",\"imei2\":\"" + details.get("imei") + "\",\"popurl\":\"2025-06-19T18:30:00.000Z\",\"product_id\":1,\"mst_model_id\":1},\"problems\":[{\"id\":2,\"remark\":\"sdc\"}]}");
    }
