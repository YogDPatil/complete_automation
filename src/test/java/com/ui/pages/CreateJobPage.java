...
public final class CreateJobPage extends BrowserUtils {
        ...
        private static final By MODEL_NAME_DROPDOWN_LOCATOR = By
                        .xpath("//mat-select[@placeholder='Select Model name']");
        ...
        private static final By WARRANTY_STATUS_OPTIONS_LOCATOR = By
                        .xpath("//div[@id='mat-select-6-panel']/mat-option");
        private static final By SELECT_PROBLE_DROPDOWN_LOCATOR = By
        ...
        public String enterJobDetailsAndCreateJob(String oem, String productName, String modelName, String date,
